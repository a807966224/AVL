...
public class InnerSplayTree<T> {
	private Node<T> root;

	public InnerSplayTree() {
		root = null;
	}
	...
	public void insert(T key) {
		...
		if (y == null) {
			root = node;
		} else if (nodeHashCode < y.hashCode()) {
			y.left = node;
		} else {
			y.right = node;
		}
	...
	public static void main(String [] args) {
		InnerSplayTree<String> tree = new InnerSplayTree<String>();
		tree.insert("33");
		tree.insert("44");
		tree.insert("67");
		tree.insert("5");
